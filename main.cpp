...
#include "ray.h"
#include "vec3.h"
#include "objetos/hittable_list.h"
#include "objetos/hittable.h"
#include "objetos/sphere.h"
...
int main() {
    ...
    for (int l = 0; l < nLin; ++l) {
        ...
        for (int c = 0; c < nCol; ++c) {
            ...
            auto ray_direction = ponto_na_janela - olho;

            ray r(olho, ray_direction);
